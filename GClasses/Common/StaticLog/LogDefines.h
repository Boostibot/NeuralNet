...
#define GLOG_INTERNAL_LOG_MSG_DO_SOURCE_OPTION_true(level, logger, ...) logger.LogMsgsSource<level>(__FILE__, __LINE__, __VA_ARGS__)
#define GLOG_INTERNAL_LOG_MSG_DO_SOURCE_OPTION_false(level, logger, ...) logger.LogMsgs<level>(__VA_ARGS__)
