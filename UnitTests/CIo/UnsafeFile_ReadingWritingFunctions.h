#ifndef UNSAFEFILE_READINGWRITINGFUNCTIONS_H
#define UNSAFEFILE_READINGWRITINGFUNCTIONS_H
...
namespace CIo::UnsafeFileTesting
{
    ...
    TEMPLATE_TEST_CASE("[UnsafeFile] : Read should read data from the file", "[UnsafeFile][Read]", UnsafeFileTestedTypes)
    {
        ...
        SECTION("reading data from a validly opened file")
        {
            ...
            {
                REQUIRE(UnsafeFile::CreateFile(cleaner.Filename()));
                UnsafeFile reader(cleaner.Filename(), OpenModeFlag::Read, OpenModeFlag::MustExist, OpenModeFlag::Binary);
                REQUIRE(reader.IsOpen() == true);
        ...
        WHEN("reading data from a invalidly opened file no data is read")
        {
            ...
            {
                UnsafeFile reader(cleaner.Filename(), COpenMode::Write);
                REQUIRE(reader.IsOpen() == true);
            ...
            WHEN("reading data from a file opened for Append only no data is read")
            {
                ...
                UnsafeFile reader(cleaner.Filename(), COpenMode::WriteAppend);
                REQUIRE(reader.IsOpen() == true);
    ...
    TEMPLATE_TEST_CASE("[UnsafeFile] : ReadAndCount should read data from the file and return the ammount of data read", "[UnsafeFile][ReadAndCount]", UnsafeFileTestedTypes)
    {
        using Cleaner    = BasicFilenameCleaner<TestType>;
        using UnsafeFile = BasicUnsafeFile<TestType>;
    ...
    TEMPLATE_TEST_CASE("[UnsafeFile] : ReadObject should read the object data from the file", "[UnsafeFile][ReadObject]", UnsafeFileTestedTypes)
    {
        using Cleaner    = BasicFilenameCleaner<TestType>;
        using UnsafeFile = BasicUnsafeFile<TestType>;
    ...
    TEMPLATE_TEST_CASE("[UnsafeFile] : ReadString should read data from the file into the string argument", "[UnsafeFile][ReadString]", UnsafeFileTestedTypes)
    {
        using Cleaner    = BasicFilenameCleaner<TestType>;
        using UnsafeFile = BasicUnsafeFile<TestType>;
    ...
    TEMPLATE_TEST_CASE("[UnsafeFile] : Write should put the appropriate data in the file", "[UnsafeFile][Write]", UnsafeFileTestedTypes)
    {
        using Cleaner    = BasicFilenameCleaner<TestType>;
        using UnsafeFile = BasicUnsafeFile<TestType>;
    ...
    TEMPLATE_TEST_CASE("[UnsafeFile] : WriteAndCount should put the appropriate data in the file and return the ammount of data written", "[UnsafeFile][WriteAndCount]", UnsafeFileTestedTypes)
    {
        using Cleaner    = BasicFilenameCleaner<TestType>;
        using UnsafeFile = BasicUnsafeFile<TestType>;
    ...
    TEMPLATE_TEST_CASE("[UnsafeFile] : WriteObject should put the whole object in the file", "[UnsafeFile][WriteObject]", UnsafeFileTestedTypes)
    {
        using Cleaner    = BasicFilenameCleaner<TestType>;
        using UnsafeFile = BasicUnsafeFile<TestType>;
    ...
    TEMPLATE_TEST_CASE("[UnsafeFile] : WriteString should only accept string types", "[UnsafeFile][WriteString]", UnsafeFileTestedTypes)
    {
        using Cleaner    = BasicFilenameCleaner<TestType>;
        using UnsafeFile = BasicUnsafeFile<TestType>;
    ...
    TEMPLATE_TEST_CASE("[UnsafeFile] : WriteString should put the contents of the provided string into the file", "[UnsafeFile][WriteString]", UnsafeFileTestedTypes)
    {
    ...
    TEMPLATE_TEST_CASE("[UnsafeFile] : WasEndOfFileRieched should return true if the end of file was reached", "[UnsafeFile][WasEndOfFileRieched]", UnsafeFileTestedTypes)
    {
        using Cleaner    = BasicFilenameCleaner<TestType>;
        using UnsafeFile = BasicUnsafeFile<TestType>;
...
#endif // UNSAFEFILE_READINGWRITINGFUNCTIONS_H
